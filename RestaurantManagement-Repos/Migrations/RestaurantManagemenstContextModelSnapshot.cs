...
namespace RestaurantManagement_Repos.Migrations
{
    ...
    partial class RestaurantManagemenstContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantManagement.Model.Entity.Customer", b =>
                {
            ...
            modelBuilder.Entity("RestaurantManagement.Model.Entity.Employee", b =>
                {
            ...
            modelBuilder.Entity("RestaurantManagement.Model.Entity.EmployeeOrder", b =>
                {
            ...
            modelBuilder.Entity("RestaurantManagement.Model.Entity.Menu", b =>
                {
            ...
            modelBuilder.Entity("RestaurantManagement.Model.Entity.Order", b =>
                {
                    b.Property<int>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RestaurantManagement.Model.Entity.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("RestaurantManagement.Model.Entity.Table", b =>
                {
                    b.Property<int>("TableId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RestaurantManagement.Model.Entity.EmployeeOrder", b =>
                {
                    b.HasOne("RestaurantManagement.Model.Entity.Employee", "Employee")
                        .WithMany("EmployeeOrder")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RestaurantManagement.Model.Entity.Order", "Order")
                        .WithMany("EmployeeOrder")
            ...
            modelBuilder.Entity("RestaurantManagement.Model.Entity.Order", b =>
                {
                    b.HasOne("RestaurantManagement.Model.Entity.Customer", "Customer")
                        .WithMany("OrderCustomer")
                        .HasForeignKey("CustomerId");

                    b.HasOne("RestaurantManagement.Model.Entity.Table", "Table")
                        .WithMany("Order")
            ...
            modelBuilder.Entity("RestaurantManagement.Model.Entity.OrderItem", b =>
                {
                    b.HasOne("RestaurantManagement.Model.Entity.Menu", "Menu")
                        .WithMany("OrderItems")
